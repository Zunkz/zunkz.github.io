...
(function() {
					...
					'ndscreenshots': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Ndscreenshots',
										'page_location': '/#ndscreenshots',
									});
								},
							],
						},
					...
					'danderscreenshots': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Danderscreenshots',
										'page_location': '/#danderscreenshots',
									});
								},
							],
						},
					...
					'dandervideos': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Dandervideos',
										'page_location': '/#dandervideos',
									});
								},
							],
						},
					...
					'danderfcs': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Danderfcs',
										'page_location': '/#danderfcs',
									});
								},
							],
						},
					...
					'danderpity': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Danderpity',
										'page_location': '/#danderpity',
									});
								},
							],
						},
					...
					'danderalts': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Danderalts',
										'page_location': '/#danderalts',
									});
								},
							],
						},
					...
					'danderd0xxing': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Danderd0xxing',
										'page_location': '/#danderd0xxing',
									});
								},
							],
						},
					...
					'dandertoxiccmnty': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Dandertoxiccmnty',
										'page_location': '/#dandertoxiccmnty',
									});
								},
							],
						},
					...
					'dandernoconsent': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Dandernoconsent',
										'page_location': '/#dandernoconsent',
									});
								},
							],
						},
					...
					'danderconvos': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Danderconvos',
										'page_location': '/#danderconvos',
									});
								},
							],
						},
					...
					'danderdcordlogs': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Danderdcordlogs',
										'page_location': '/#danderdcordlogs',
									});
								},
								function() { 
									window._sectionTimeoutId = setTimeout(function() { location.href = '#dander'; }, 1000);
								},
							],
						},
					},
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#divider06', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 375, replay: false });
		...
		onvisible.add('h1.style10, h2.style10, h3.style10, p.style10', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#divider08', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 375, replay: false });
		onvisible.add('#text70', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#divider09', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 375, replay: false });
		onvisible.add('#gallery13', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('#container17', { style: 'fade-in', speed: 500, intensity: 2, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('#container24', { style: 'fade-in', speed: 500, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('#gallery08', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#divider01', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 375, replay: false });
