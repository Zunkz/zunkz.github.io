...
(function() {
					...
					'ndolderacc': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Ndolderacc',
										'page_location': '/#ndolderacc',
									});
								},
							],
						},
					...
					'danderdcordlogs': {
						events: {
							onopen: [
								...
								function() { 
									setTimeout(function() { location.href = '#dander'; }, 1000);
								},
							],
						},
					},
					'nickserverlogs': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Nickserverlogs',
										'page_location': '/#nickserverlogs',
									});
								},
							],
						},
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#text66', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
