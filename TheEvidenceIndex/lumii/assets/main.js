...
(function() {
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Lumii',
										'page_location': 'https://eviindex2.carrd.co',
									});
								},
							],
						},
					...
					'lumiiscreenshots': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Lumiiscreenshots',
										'page_location': 'https://eviindex2.carrd.co/#lumiiscreenshots',
									});
								},
							],
						},
					...
					'lumiivideos': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Lumiivideos',
										'page_location': 'https://eviindex2.carrd.co/#lumiivideos',
									});
								},
							],
						},
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#container01', { style: 'fade-in', speed: 500, intensity: 2, threshold: 3, delay: 0, replay: false });
